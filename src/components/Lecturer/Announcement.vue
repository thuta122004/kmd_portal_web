  ...
  <div class="max-w-3xl mx-auto pb-12 space-y-6 animate-fade-in relative">
    ...
    >
      ...
      <p class="text-sm text-slate-500">
        There are no new announcements for your assigned sections or the school at this time.
      </p>
    </div>
  </div>
</template>
...
const fetchLecturerAnnouncements = async () => {
  ...
  try {
    ...
    errorMessage.value = 'Unable to load your announcement feed at this time.'
  } finally {
